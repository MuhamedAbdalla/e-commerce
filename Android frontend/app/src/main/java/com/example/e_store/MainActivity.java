    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (id.equals("") && Cart.custID == -1) {
            ...
            while (cursor != null && !cursor.isAfterLast()) {
                products.add(new Product(Integer.parseInt(cursor.getString(0)), cursor.getString(1), cursor.getColumnName(4),
            ...
            lst_categories.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    while (lst != null && !lst.isAfterLast()) {
                        products.add(new Product(Integer.parseInt(lst.getString(0)), lst.getString(1), lst.getColumnName(4),
            ...
            lst_products.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    details.putExtra("proID", products.get(position).proID);
                    details.putExtra("catID", products.get(position).catID);
                    details.putExtra("custID", id);
